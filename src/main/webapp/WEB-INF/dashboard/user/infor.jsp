                                        ...
                                        <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info">
                                            ...
                                            <form method="post" action="/user">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="username" class="form-control" id="name" placeholder="Change user name" value="${sessionScope.user.getUsername()}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="designation">Full Name</label>
                                                    <input type="text" name="fullname" class="form-control" id="designation" placeholder="Change designation" value="${sessionScope.user.getFullname()}">
                                                </div>
                                                <div class="form-group">
